...
drop table if exists "pagcaixa" cascade;
drop table if exists "caixa" cascade;
drop table if exists "rantorneio" cascade;
drop table if exists "usutorneio" cascade;
drop table if exists "usuevento" cascade;
drop table if exists "usucategoria" cascade;
drop table if exists "pagfidelidade" cascade;
drop table if exists "fidelidade" cascade;
drop table if exists "usuranking" cascade;
drop table if exists "categoria" cascade;
drop table if exists "usupremiacao" cascade;
